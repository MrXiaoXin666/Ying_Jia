  ...
  <tr>
    <td valign="middle" align="center"><div id="box_login">
     ...
     <div id="right_login">
       <h1>网站后台管理系统</h1>
       <h2>欢迎登陆！</h2>
      <form action="houtaiLogin" method="post">
                  <div class="input-group input-group-lg">
			        <input type="text" id="userName" class="form-control txt" placeholder="用户名" aria-describedby="sizing-addon1">
					<span class="iconfont" style="color:#1fbba6;font-size:24px;margin-left:-30px;position:absolute;z-index:2;margin-top:8px">&#xe61c;</span>
                  </div>
                  <div class="input-group input-group-lg">
   					<input type="password" id="password" class="form-control txt" placeholder="密&nbsp;&nbsp;&nbsp;码" aria-describedby="sizing-addon1">
                    <span class="iconfont" style="color:#1fbba6;font-size:24px;margin-left:-30px;position:absolute;z-index:2;margin-top:8px">&#xe61a;</span>
                 </div>
                 <div class="input-group input-group-lg">
			        <input type="text" id="mobilePhone" class="form-control txt" placeholder="手机号" aria-describedby="sizing-addon1">
					<span class="iconfont" style="color:#1fbba6;font-size:24px;margin-left:-30px;position:absolute;z-index:2;margin-top:8px">&#xe61d;</span>
                  </div>
                   <div class="input-group input-group-lg bd">
			        <input type="text" id="code" class="form-control txt" placeholder="验证码" aria-describedby="sizing-addon1">
