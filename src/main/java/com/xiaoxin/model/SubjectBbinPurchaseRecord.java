...
public class SubjectBbinPurchaseRecord {
	 ...
	 */
	 ...
	 @Id
	 @SequenceGenerator(name="subject_bbin",sequenceName="sql_subject_bbin",allocationSize=1)
	 @GeneratedValue(generator="subject_bbin",strategy=GenerationType.SEQUENCE)
